...
function TaskForm () {
    ...
    return(
        <div>
            ...
            {task && <form  onSubmit = {handleSubmit} id = "taskForm" className="d-flex flex-column justify-content-around align-items-center" style={{width: '400px', margin:'auto', marginTop: '100px'}}>
